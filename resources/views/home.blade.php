...
@section('content')
    ...
    <div id="elemento_ajax_html" name="addItem" method="POST" class="list">
        ...
        @foreach ($produtos as $produto)
            ...
            {{-- Modal Sem grade --}}
            <div class="modal fade" id="SemGrade{{ $produto->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <form id="formModalSemGrade" name="addItemSemGrade" method="POST" class="list">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button id="fechaModalSemGrade<?php echo $produto->id; ?>" type="button" class="btn btn-secondary"
