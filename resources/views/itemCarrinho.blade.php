        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('busca_cliente_ajax') }}" method="GET" class="search-cliente">
                    ...
                    <button id="preventCliente" class="lupa"><i class="bi-search" style="color: black"></i></button> 
                </form>
                    ...
                    <ul class="list-group">
                        @foreach ($clientes_user as $cliente)
                            ...
                            <li style="text-align:justify; overflow-x: auto; overflow-y: hidden;overflow-y: hidden;"
                                ...
                                {{ $cliente->nome }}
                                <button type="submit" name="cliente_id" value="{{ $cliente->id }}" class="lupa-list"><i class="bi bi-save2"></i></button>
                            </li>
                        @endforeach
            ...
            @foreach ($itens->carItem as $item)
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center"
                        ...
                        <a href="" style="color: black; font-weight: 500; text-decoration:none;">{{ $item->nome }}</a>
