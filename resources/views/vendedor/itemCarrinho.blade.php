...
<br><br><br><br>
            ...
            @else
                <!-- Modal Unifica -->
                <div class="modal fade" id="modalUnifica" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog  modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Unificar Desconto</h5><br>
                                <button id="fechaModalUnificaDesconto" type="button" class="btn-close"
                                    data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>

                            <form method="post"
                                action="{{ route('unifica_valor_Itens', ['carrinho' => $carrinho->id]) }}">
                                @csrf
                                @method('put')
                                    ...
                                    <div class="row g-2">
                                        <div class="col-8">
                                            <div class="form-floating">
                                                <input required name="qtd_unificado" type="number" class="form-control"
                ...
                <div class="modal fade" id="confzerarDesconto" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal fade" id="cancelaVenda" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="card-box bg-green">
                                    <div class="inner">
                                        <h6><i class="bi bi-cash-coin"> Subtotal&ensp;R$<u>{{ reais($carrinho->valor_bruto) }}</u></i>
                                        </h6>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="card-box bg-orange">
                                    ...
                                    <div class="inner">
                                        <p style="color:black;" >&ensp;{{ $carrinho->tp_desconto == 'porcento_unico'? "Unificado em % $carrinho->desconto_qtd": ($carrinho->tp_desconto == 'dinheiro_unico'? "Unificado em R$ $carrinho->desconto_qtd": (!$carrinho->tp_desconto? 'Nenhum Desconto Aplicado': 'Desconto Dado Parcialmente')) }}
                                        </p>
                                    </div>
                ...
                {{-- Fim cards iniciais --}}
                <div class="row d-flex justify-content-center">
                    <button type="button" class="btn btn-primary col-5 mx-2" data-bs-toggle="modal"
                ...
                <div class="row d-flex justify-content-center" style="margin-top: 10px;">
                    ...
                    @if ($carrinho->cliente)
                        ...
                        <div class="modal fade" id="modalFinalizaVendaComCLientSalvo" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" name="formFinalizaVenda"
                                        ...
                                        <input type="hidden" name="hiddenInputValorDescontoModal"
                                            id="hiddenValorDescontoModal" value="<?php echo $carrinho->valor_desconto; ?>">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-8">
                                                    <div class="form-floating">
                                                        <input id="clienteNomeVenda" Readonly type="text"
                                                ...
                                                <div class="col-4">
                                                    <div class="form-floating">
                                                        <input name="cliente_alltech_id" required Readonly type="text"
                                                            class="form-control"
                                                            value="{{ $carrinho->cliente->alltech_id }}"
                                                            id="floatingInputGrid">
                                                ...
                                                <div class="col-8">
                                                    <div class="form-floating">
                                                        <input disabled
                                                            ...
                                                            name="qtd_desconto_sobre_venda" type="number"
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <div class="form-floating">
                                                        <input name="parcelas" disabled min="1" type="text"
                        ...
                        <div class="modal fade" id="salvarItensRetornados" data-bs-backdrop="static"
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                    ...
                                    <a href="" style="color: black; font-weight: 400; text-decoration:none;">Total: R$
                                        {{ reais($item->valor) }}</a><a class="badge  rounded-pill"
                                        data-bs-toggle="modal" data-bs-target="#editaItem{{ $item->id }}"><i
                            ...
                            <button class="btn btn-link" type="button"><i class="bi bi-plus-circle"></i></button>
                                ...
                                <div class="modal fade" id="editaItem{{ $item->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="margin-left: 35%;"
                                            ...
                                            <form method="POST"
                                                action="{{ route('venda.update', ['venda' => $item->id]) }}">
                                                @method('PUT')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row g-2">
                                ...
                                <div class="modal fade" id="deleteItemCarrinho{{ $item->id }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('destroy_item', ['item' => $item->id]) }}"
                                ...
                                <form id="formFinalizaVendaSubmit" method="POST" name="formFinalizaVenda"
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-2">
                                            <div class="col-4">
                                                <div class="form-floating">
                                                    <input required name="cliente_alltech_id" id="clienteCodigo" type="text"
                                                        class="form-control"
                                                        value="{{ $carrinho->cliente_id ? $carrinho->cliente->alltech_id : '999999' }}"
                                            ...
                                            <div class="col-8">
                                                <div class="form-floating">
                                                    <input id="clienteNomeVenda" required Readonly type="text"
                                                        class="form-control" required name="nomeCLienteFinaliza"
                                                        value="Venda A Vista" id="floatingInputGrid"
                                                        placeholder="quantidade">
                                                    <label for="floatingInputGrid">Cliente</label>
                                                </div>
                                                <span id="nomeValid"></span>
                                            ...
                                            <a onclick="fechaModalfinalizaVenda()" class="btn btn-primary"
                                                data-bs-toggle="modal" data-bs-target="#modalbuscaClienteNomeVendaAjax"><i
                                                    class="bi-search" style="color: rgb(255, 255, 255)"></i></a>
                                        </div>
                                        <br>
                                            ...
                                            <div class="col-8">
                                                <div class="form-floating">
                                                    <input disabled required
                                                        onkeyup="calculoDescontoSobreVenda(<?php echo $carrinho->total; ?>, <?php echo $carrinho->valor_desconto; ?>)"
                                                        name="qtd_desconto_sobre_venda" type="number"
                                                        class="form-control" min="0.01" step="0.01" id="inputDesconto">
                                                    <label for="floatingInputGrid">Desconto</label>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-6">
                                                <div class="form-floating">
                                                    <input disabled required name="parcelas" type="text"
                                                        class="form-control" placeholder="1" value="1"
                                                        id="inputParcelas">
                                                    <label for="floatingInputGrid">Parcelas</label>
                                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="formSalvaItensCliente" method="GET" class="search-cliente">
                                    ...
                                    <input id="buscaNomeClienteVendaAjax" type="text" class="form-control"
                                        placeholder="nome">
                                    <button id="botaoBuscaClienteNomeAjax" class="lupa"><i
                                            class="bi-search" style="color: black"></i></button>
                                </form>
                                ...
                                <div class="modal-footer">
                                    <button id="closeModalbuscaClienteNomeVendaAjax" type="button"
