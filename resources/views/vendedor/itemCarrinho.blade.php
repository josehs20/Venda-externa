                ...
                <div class="row d-flex justify-content-center">
                        ...
                        <div class="card-box bg-green">
                            <div class="inner">
                                <h6><i class="bi bi-cash-coin"> Sem
                                        Desconto:&ensp;R$<u>{{ reais($carrinho->valor_bruto) }}</u></i>
                                </h6>

                            </div>
                            <div class="inner">
                                <h6><i class="bi bi-cash-coin"> Com
                                        Desconto:&ensp;<u>{{ 'R$' . reais($carrinho->total) }}</u></i>
                                </h6>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="card-box bg-orange">
                            ...
                            <div class="inner">
                                <p>&ensp;{{ $carrinho->tp_desconto == 'porcento_unico'? "Unificado em % $carrinho->desconto_qtd": ($carrinho->tp_desconto == 'dinheiro_unico'? "Unificado em R$ $carrinho->desconto_qtd": (!$carrinho->tp_desconto? 'Nenhum Desconto Aplicado': 'Desconto Dado Parcialmente')) }}
                                </p>
                            </div>
                ...
                <div class="modal fade" id="modalFinalizaVendaComCLientSalvo" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" name="formFinalizaVenda" action="{{ route('finaliza_venda', ['carrinho' => $carrinho->id]) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <span style="font-size: 14px;" class="mx-1"><u>Deseja aplicar desconto sobre a
                                            venda?</u></span>
                                    <br><br>
                                    <div class="row g-2">
                                        <div class="col-8">
            ...
            <div class="modal fade" id="modalFinalizaVendaSemCliente" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="formFinalizaVendaSubmit" method="POST" name="formFinalizaVenda" action="{{ route('finaliza_venda', ['carrinho' => $carrinho->id]) }}">
                            @method('PUT')
                            @csrf
                            <input type="hidden" name="hiddenInputValorTotalModal" id="hiddenValorTotalModal"
                                value="<?php echo $carrinho->total; ?>">
            ...
            <div class="modal fade" id="modalbuscaClienteNomeVendaAjax" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button id="closeModalbuscaClienteNomeVendaAjax" type="button" class="btn btn-secondary"
